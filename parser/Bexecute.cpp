...
//	   << rel->rel_var () << std::endl;
//    }

//  for (i=0; i<Aglob_vars()->query->numpreds (); i++)
//    std::cout << '[' << i << "] " 
//	 << Aglob_vars()->query->pred (i)->ptree () << std::endl;
//  for (i=0; i<Aglob_vars()->query->numoperations (); i++)
//    std::cout << '[' << i << "] " 
//	 << *Aglob_vars()->query->operation (i) << std::endl;
...
//       << setw (7) << Aglob_vars()->search->phynode_ctr.max () << std::endl;
//   std::cout
...
//       << setw (7) << Aglob_vars()->search->subopt_phynode_ctr.max () << std::endl;

  Bexecute_plan (access_plan);
  std::cout << "output" << std::endl;
  std::cout << "------------------------------------------------" << std::endl;
  std::cout << "Estimated cost (secs.) : " 
       << access_plan->GetPhyProps ()->GetCost () << std::endl;
  std::cout << rusage << std::endl;
}
